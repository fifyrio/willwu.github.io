  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-bold">with 8 years of experience</p>
        <p className="text-xl">
          in Swift, Objective-C, Python, Node<span className="text-sm"> etc.</span>
        </p>

        <p className="text-base">
          <a
            className="underline mr-2 "
            href="mailto:fifyriocat@gmail.com"
          >
            fifyriocat@gmail.com
          </a>
          <span className="w-150 inline-block sm:inline"> +86-17521328834</span>
        </p>
        <p className=" text-lg">Mobile Dev</p>
        <p className="text-base">
      ...
      >
        <Link
          ...
          href={`${
            process.env.NODE_ENV === "production"
              ? "https://willwu-portfolio.vercel.app/"
              : "localhost:3000"
          }#projects`}
        ...
        <a
          ...
          onClick={(e) => {
            e.preventDefault();
            window.open('https://chatmentor.sfo3.cdn.digitaloceanspaces.com/static/iOS-developer-Wu%20Wei.pdf');            
          }}
        >
          Download CV{" "}
        ...
        <div className="flex">
          <a
            ...
            href="https://www.linkedin.com/in/willwu-hacker/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
